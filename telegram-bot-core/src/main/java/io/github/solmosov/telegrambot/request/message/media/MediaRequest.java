...
import io.github.solmosov.telegrambot.model.ParseMode;
import io.github.solmosov.telegrambot.request.message.AbstractMessageRequest;

@JsonInclude(JsonInclude.Include.NON_NULL)
abstract class MediaRequest extends AbstractMessageRequest {
