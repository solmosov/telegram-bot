...
class SendAudioRequestTest {
    ...
    @Test
    void shouldSerializeAudioUrlAndDuration() throws Exception {
    ...
    @Test
    void shouldOmitDurationWhenItIsNotProvided() throws Exception {
        String audioUrl = "https://example.com/audio.mp3";
    ...
    @Test
    void shouldOmitAudioWhenItIsNotProvided() throws Exception {
        SendAudioRequest request = SendAudioRequest.builder()
                .duration(120)
                .build();
    ...
    @Test
    void shouldSerializeZeroDuration() throws Exception {
        String audioUrl = "https://example.com/audio.mp3";
        ...
        assertEquals(audioUrl, json.get("audio").asString());
        assertEquals(0, json.get("duration").asInt());
    }
}